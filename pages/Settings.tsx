...
import { SharingConfig, TeamMember, BankDetails, Role } from '../types';
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
                  ...
                  <div className="space-y-4">
                      <div>
                          ...
                          <input type="text" value={profileForm.name || ''} readOnly className="w-full bg-slate-50 border border-slate-200 p-3 rounded-xl mt-1 font-bold" />
                      </div>
                      <div>
                          <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Account Context</label>
                          <input type="text" value={`${profileForm.role} - Level ${profileForm.level} (${globalConfig.levelNames[profileForm.level as keyof typeof globalConfig.levelNames]})`} readOnly className="w-full bg-slate-50 border border-slate-200 p-3 rounded-xl mt-1 font-bold" />
                      </div>
                  </div>
              </div>
          </div>
